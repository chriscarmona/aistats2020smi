...
\tikzstyle{param}=[circle, minimum size = 0.7cm, thick, draw=black!100, fill = gray!10, node distance = 0.5cm]
\tikzstyle{data}=[rectangle, minimum size = 0.7cm, thick, draw =black!100, node distance = 0.5cm]
\tikzstyle{model}=[rectangle, minimum size = 1cm, thick, draw=black!100, node distance = 0.5cm]
